...
|------|--------|----------|--------|----------|--------|-------------|----------|
| 🥇 1 | [tensorflow/tensorflow](https://github.com/tensorflow/tensorflow) | 面向所有人的开源机器学习框架 | **195.6k** | +0 | +0.0% | 319 | **40.0** |
| 🥈 2 | [huggingface/transformers](https://github.com/huggingface/transformers) | 🤗 Transformers ：用于推理和训练的文本、视觉、音频和多模... | **161.3k** | +0 | +0.0% | 67 | **8.4** |
| 🥉 3 | [gradio-app/gradio](https://github.com/gradio-app/gradio) | 在Python中构建和分享令人愉悦的机器学习应用程序。🌟STAR支持我... | **42.8k** | +0 | +0.0% | 27 | **3.39** |
| 4 | [lutzroeder/netron](https://github.com/lutzroeder/netron) | 神经网络、深度学习和机器学习模型的可视化工具 | **33.0k** | +0 | +0.0% | 23 | **2.88** |
| 5 | [scikit-learn/scikit-learn](https://github.com/scikit-learn/scikit-learn) | Scikit-learn: Machine learning in P... | **66.3k** | +0 | +0.0% | 20 | **2.51** |
| 6 | [wppconnect-team/wppconnect](https://github.com/wppconnect-team/wppconnect) | WPPConnect是JavaScript社区开发的开源项目，旨在将函... | **3.3k** | +0 | +0.0% | 5 | **0.63** |
| 7 | [Josh-XT/AGiXT](https://github.com/Josh-XT/AGiXT) | AGiXT是动态人工智能代理自动化平台，可无缝协调不同人工智能提供商的... | **3.2k** | +0 | +0.0% | 5 | **0.63** |
| 8 | [opengeos/geoai](https://github.com/opengeos/geoai) | GeoAI ：地理空间数据的人工智能 | **3.1k** | +0 | +0.0% | 5 | **0.63** |
| 9 | [taranis-ai/taranis-ai](https://github.com/taranis-ai/taranis-ai) | Taranis AI是一种先进的开源智能(OSINT)工具，利用人工智... | **1.1k** | +0 | +0.0% | 5 | **0.63** |
| 10 | [py-why/EconML](https://github.com/py-why/EconML) | ALICE (Automated Learning and Intel... | **4.7k** | +0 | +0.0% | 2 | **0.25** |
| 11 | [steven2358/awesome-generative-ai](https://github.com/steven2358/awesome-generative-ai) | 现代生成人工智能项目和服务的精选列表 | **12.1k** | +0 | +0.0% | 1 | **0.13** |
| 12 | [josephmisiti/awesome-machine-learning](https://github.com/josephmisiti/awesome-machine-learning) | 精心策划的优秀机器学习框架、库和软件列表。 | **72.7k** | +0 | +0.0% | 1 | **0.13** |
| 13 | [AMAI-GmbH/AI-Expert-Roadmap](https://github.com/AMAI-GmbH/AI-Expert-Roadmap) | 2022年成为人工智能专家的路线图 | **31.1k** | +0 | +0.0% | 0 | **0.0** |
| 14 | [feder-cr/Jobs_Applier_AI_Agent_AIHawk](https://github.com/feder-cr/Jobs_Applier_AI_Agent_AIHawk) | AIHawk旨在通过自动化求职流程来简化求职流程。利用人工智能，它使用... | **29.9k** | +0 | +0.0% | 0 | **0.0** |
...
<div style="margin-top: 12px;"><b>🎯 核心功能</b><ul style="margin: 8px 0 0 20px; padding: 0;"><li style='margin: 4px 0;'>leveraging 人工智能 to revolutionize information gathering and situational analysis</li></ul></div>
...
<div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 12px; margin-top: 16px; padding-top: 16px; border-top: 1px solid #d1d9e0;">
  <div style="background: white; padding: 12px; border-radius: 8px; text-align: center;">
    <div style="font-size: 0.85em; color: #656d76; margin-bottom: 4px;">⭐ 总 Star</div>
    <div style="font-size: 1.4em; font-weight: bold; color: #1f2328;">29,862</div>
  </div>
  <div style="background: white; padding: 12px; border-radius: 8px; text-align: center;">
    <div style="font-size: 0.85em; color: #656d76; margin-bottom: 4px;">📈 本周新增</div>
    <div style="font-size: 1.2em; font-weight: bold;"><span>0 (0.0%)</span></div>
...
|------|--------|--------|----------|--------|
| 🔥 🥇 1 | [tensorflow/tensorflow](https://github.com/tensorflow/tensorflow) | **+0.0%** | +0 | **195.6k** |
| 🔥 🥈 2 | [huggingface/transformers](https://github.com/huggingface/transformers) | **+0.0%** | +0 | **161.3k** |
| 🔥 🥉 3 | [gradio-app/gradio](https://github.com/gradio-app/gradio) | **+0.0%** | +0 | **42.8k** |
| 4 | [lutzroeder/netron](https://github.com/lutzroeder/netron) | **+0.0%** | +0 | **33.0k** |
| 5 | [scikit-learn/scikit-learn](https://github.com/scikit-learn/scikit-learn) | **+0.0%** | +0 | **66.3k** |
| 6 | [wppconnect-team/wppconnect](https://github.com/wppconnect-team/wppconnect) | **+0.0%** | +0 | **3.3k** |
| 7 | [Josh-XT/AGiXT](https://github.com/Josh-XT/AGiXT) | **+0.0%** | +0 | **3.2k** |
| 8 | [opengeos/geoai](https://github.com/opengeos/geoai) | **+0.0%** | +0 | **3.1k** |
| 9 | [taranis-ai/taranis-ai](https://github.com/taranis-ai/taranis-ai) | **+0.0%** | +0 | **1.1k** |
| 10 | [py-why/EconML](https://github.com/py-why/EconML) | **+0.0%** | +0 | **4.7k** |
...
- **[gradio-app/gradio](https://github.com/gradio-app/gradio)**：+0.0% 周涨幅，新增 0 Star
